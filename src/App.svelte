    ...
    <div style="position:relative; top:48px; right:-115px">
      ...
      <div style="position:absolute; left:0px; top:0px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          <div class="legendtitle">Náchylní (Susceptible)</div>
          ...
          <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 4px; position:relative;">Náchylní a neimunní.</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*1}px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          <div class="legendtitle">Vystavení (Exposed)</div>
        ...
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 4px; position:relative;">Část populace v inkubační periodě.</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*2}px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          <div class="legendtitle">Infekční (Infectious)</div>
          <div style="padding-top: 5px; padding-bottom: 1px">
        ...
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 4px; position:relative;">Infekční a <i>aktivně</i> roznášející.</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*3}px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          <div class="legendtitle">Odstranění (Removed)</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*4+14-3}px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          <div class="legendtitle">Vyléčení</div>
        ...
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 8px; position:relative;">Plně vyléčení.</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*4+57}px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          <div class="legendtitle">Hospitalizovaní</div>
          <div style="padding-top: 3px; padding-bottom: 1px">
      ...
      <div style="position:absolute; left:0px; top:{legendheight*4 + 120+2}px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          <div class="legendtitle">Fatality</div>
          <div style="padding-top: 3px; padding-bottom: 1px">          
        ...
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 10px; position:relative;">Umrtí.</div>
      </div>
    </div>
  </div>
    ...
    <div style="position:relative; top:60px; left: 10px">
      ...
      <div style="position: absolute; width:{width+15}px; height: {height}px; position: absolute; top:100px; left:10px; pointer-events: none">
        ...
        <div id="interventionDrag" class="legendtext" style="flex: 0 0 160px; width:120px; position:relative;  top:-70px; height: 60px; padding-right: 15px; left: -125px; pointer-events: all;cursor:col-resize;" >
          <div class="paneltitle" style="top:9px; position: relative; text-align: right">Intervence {format("d")(InterventionTime)}. den</div>
...
<!--
    ...
    <div style="opacity:{xScaleTime(InterventionTime) >= 192? 1.0 : 0.2}">
      <div class="tick" style="color: #AAA; position:absolute; pointer-events:all; left:10px; top: 10px">
        <Checkbox color="#CCC" bind:checked={log}/><div style="position: relative; top: 4px; left:20px">lineární měřítko</div>
      </div>
    </div>
...
<div style="height:220px;">
  <div class="minorTitle">
    <div style="margin: 0px 0px 5px 4px" class="minorTitleColumn">Vlastnosti šíření</div>
    <div style="flex: 0 0 20; width:20px"></div>
    <div style="margin: 0px 4px 5px 0px" class="minorTitleColumn">Vlastnosti nemoci</div>
  </div>
  <div class = "row">

    <div class="column">
      <div class="paneltitle">Specifika společnosti</div>
      <div class="paneldesc" style="height:30px">Velikost populace.<br></div>
      ...
      <div class="paneldesc" style="height:29px; border-top: 1px solid #EEE; padding-top: 10px">Počet prvních nakažených.<br></div>
    ...
    <div class="column">
      <div class="paneltext">
      <div class="paneltitle">Reprodukční číslo {@html math_inline("\\mathcal{R}_0")} </div>
    ...
    <div class="column">
      <div class="paneltitle">Časy šíření</div>
      <div class="paneldesc" style="height:30px">Inkubační doba, {@html math_inline("T_{\\text{inc}}")}.<br></div>
      <div class="slidertext">{(D_incbation).toFixed(2)} Dní</div>
    ...
    <div class="column">
      <div class="paneltitle">Poskytovaná péče</div>
      <div class="paneldesc" style="height:30px">Procento potřebujících hospitalizaci.<br></div>
      ...
      <div class="paneldesc" style="height:29px; border-top: 1px solid #EEE; padding-top: 10px">Čas do hospitalizace.<br></div>
      <div class="slidertext">{D_hospital_lag} Dní</div>
